package fr.parisbackgammon.config;
...
@EnableJpaRepositories(basePackages = { "fr.parisbackgammon" })
@EnableTransactionManagement
@PropertySource("classpath:application.properties")
@ComponentScan(basePackages = { "fr.parisbackgammon" })
public class SpringConfig {
	...
	/**
	 * @return data source (BDD, driver, url et accès,)
	 */
	@Bean
